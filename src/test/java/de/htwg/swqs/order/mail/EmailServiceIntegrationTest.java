...
/**
 * Testcase for testing our 'real' mail server;
...
public class EmailServiceIntegrationTest {
    ...
    private EmailServerResponse callEmailFakeServerToAccessEmail(String recipient) {
        ...
        try {
            ...
            URL url = new URL("http://api.smtpbucket.com/emails" + "?" + "sender=webshop%40swqs.org&recipient=" + recipientAddress[0] + "%40" + recipientAddress[1]);
