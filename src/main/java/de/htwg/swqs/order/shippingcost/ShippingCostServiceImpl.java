...
public class ShippingCostServiceImpl implements ShippingCostService {
    ...
    /**
     * Calculates the shipping costs for a given list of ShoppingItems
     * and a CustomerInfo. If the customer lives outside of the default country,
     * an additional charge for international shipping will be added
     *
    ...
    public BigDecimal calculateShippingCosts(CustomerInfo customerInfo, List<OrderItem> orderItems) {
        ...
        BigDecimal internationalShippingExtraCost = customerInfo.getIsoCountryCode().equals(DEFAULT_COUNTRY) ? new BigDecimal("0") : new BigDecimal("10.99");
